...
|---|---|---|---|
| [`1942`](cores/1942/README.md) | 1942 (Revision B) (`1942`)<br>Pirate Ship Higemaru (`higemaru`)<br>Vulgus (set 1) (`vulgus`) | Capcom, 1984 | 2026-08-07 |
| [`1943`](cores/1943/README.md) | 1943 Kai: Midway Kaisen (Japan) (`1943kai`)<br>1943: The Battle of Midway (Euro) (`1943`)<br>1943: The Battle of Midway Mark II (US) (`1943mii`) | Capcom, 1987 | 2026-08-07 |
| [`ajax`](cores/ajax/) | Ajax (`ajax`) | Konami, 1987 | 2026-08-07 |
| [`aliens`](cores/aliens/README.md) | Aliens (World set 1) (`aliens`)<br>Crime Fighters (World 2 players) (`crimfght`)<br>Gang Busters (set 1) (`gbusters`)<br>Super Contra (set 1) (`scontra`)<br>Thunder Cross (set 1) (`thunderx`) | Konami, 1988–1990 | 2026-08-07 |
| [`asterix`](cores/asterix/) | Asterix (ver EAD) (jlrh) (`asterix`) | Konami, 1992 | 2026-08-07 |
| [`biocom`](cores/biocom/README.md) | Bionic Commando (Euro) (`bionicc`) | Capcom, 1987 | 2026-08-07 |
| [`circus`](cores/circus/) | Circus Charlie (level select, set 1) (`circusc`) | Konami, 1984 | 2026-08-07 |
| [`commnd`](cores/commnd/README.md) | Commando (World) (`commando`) | Capcom, 1985 | 2026-08-07 |
| [`comsc`](cores/comsc/README.md) | Combat School (joystick) (`combatsc`) | Konami, 1988 | 2026-08-07 |
| [`contra`](cores/contra/README.md) | Contra (US - Asia, set 1) (`contra`) | Konami, 1987 | 2026-08-07 |
| [`cop`](cores/cop/) | Hippodrome (US) (`hippodrm`)<br>Robocop (World, revision 4) (`robocop`) | Data East Corporation, 1988–1989 | 2026-08-07 |
| [`cps15`](cores/cps15/README.md) | Cadillacs and Dinosaurs (World 930201) (`dino`)<br>Muscle Bomber Duo: Ultimate Team Battle (World 931206) (`mbombrd`)<br>Saturday Night Slam Masters (World 930713) (`slammast`)<br>Tenchi wo Kurau II: Sekiheki no Tatakai (CPS Changer, Japan 921031) (`wofch`)<br>The Punisher (World 930422) (`punisher`)<br>Warriors of Fate (World 921031) (`wof`) | Capcom, 1992–1994 | 2026-08-07 |
| [`dd`](cores/dd/README.md) | Double Dragon (World set 1) (`ddragon`) | Technos Japan (Taito license), 1987 | 2026-08-07 |
| [`dd2`](cores/dd2/README.md) | Double Dragon II: The Revenge (World) (`ddragon2`) | Technos Japan, 1988 | 2026-08-07 |
...
| [`riders`](cores/riders/README.md) | Golfing Greats (World, version L) (`glfgreat`)<br>Lightning Fighters (World) (`lgtnfght`)<br>Sunset Riders (4 Players ver EAC) (`ssriders`)<br>Teenage Mutant Ninja Turtles: Turtles in Time (4 Players ver UAA) (`tmnt2`) | Konami, 1990–1991 — JOTEGO port | 2026-08-07 |
...
| [`ajax`](cores/ajax/) | Ajax (`ajax`) | Konami, 1987 | 2026-08-07 |
| [`aliens`](cores/aliens/README.md) | Aliens (World set 1) (`aliens`)<br>Crime Fighters (World 2 players) (`crimfght`)<br>Gang Busters (set 1) (`gbusters`)<br>Super Contra (set 1) (`scontra`)<br>Thunder Cross (set 1) (`thunderx`) | Konami, 1988–1990 | 2026-08-07 |
| [`aligator`](cores/aligator/) | Alligator Hunt (Gaelco, 1994) (jlrh) (`aligator`) | Gaelco, 1994 — jlrh port | 2026-08-07 |
| [`asterix`](cores/asterix/) | Asterix (ver EAD) (jlrh) (`asterix`) | Konami, 1992 | 2026-08-07 |
| [`bigkarnk`](cores/bigkarnk/) | Big Karnak (Gaelco, 1991) (jlrh) (`bigkarnk`) | Gaelco, 1991 — jlrh port | 2026-08-07 |
| [`biocom`](cores/biocom/README.md) | Bionic Commando (Euro) (`bionicc`) | Capcom, 1987 | 2026-08-07 |
| [`biomtoy`](cores/biomtoy/) | Biomechanical Toy (Gaelco, 1995) (jlrh) (`biomtoy`) | Gaelco / Zeus, 1995 — jlrh port | 2026-08-07 |
| [`btiger`](cores/btiger/README.md) | Black Tiger (`blktiger`) | Capcom, 1987 — JOTEGO port | 2026-08-07 |
| [`bubl`](cores/bubl/README.md) | Bubble Bobble (Japan, Ver 0.1) (`bublbobl`)<br>Tokio - Scramble Formation (newer) (`tokio`) | Taito Corporation, 1986 — JOTEGO port | 2026-08-07 |
| [`castle`](cores/castle/README.md) | Haunted Castle (version M) (`hcastle`) | Konami, 1988 — JOTEGO port | 2026-08-07 |
| [`circus`](cores/circus/) | Circus Charlie (level select, set 1) (`circusc`) | Konami, 1984 | 2026-08-07 |
| [`commnd`](cores/commnd/README.md) | Commando (World) (`commando`) | Capcom, 1985 | 2026-08-07 |
| [`comsc`](cores/comsc/README.md) | Combat School (joystick) (`combatsc`) | Konami, 1988 | 2026-08-07 |
| [`contra`](cores/contra/README.md) | Contra (US - Asia, set 1) (`contra`) | Konami, 1987 | 2026-08-07 |
| [`cop`](cores/cop/) | Hippodrome (US) (`hippodrm`)<br>Robocop (World, revision 4) (`robocop`) | Data East Corporation, 1988–1989 | 2026-08-07 |
| [`cps1`](cores/cps1/README.md) | 1941: Counter Attack (World 900227) (`1941`)<br>Adventure Quiz Capcom World 2 (Japan 920611) (`cworld2j`)<br>Captain Commando (World 911202) (`captcomm`)<br>Carrier Air Wing (World 901012) (`cawing`)<br>Dynasty Wars (USA, B-Board 89624B-?) (`dynwar`)<br>Final Fight (World, set 1) (`ffight`)<br>Forgotten Worlds (World, newer) (`forgottn`)<br>Ghouls'n Ghosts (World) (`ghouls`)<br>Gulun.Pa! (Japan 931220 L) (prototype) (`gulunpa`)<br>Knights of the Round (World 911127) (`knights`)<br>Magic Sword: Heroic Fantasy (World 900725) (`msword`)<br>Magical Pumpkin: Puroland de Daibouken (Japan 960712) (`mpumpkin`)<br>Mega Man: The Power Battle (CPS1, USA 951006) (`megaman`)<br>Mega Twins (World 900619) (`mtwins`)<br>Mercs (World 900302) (`mercs`)<br>Nemo (World 901130) (`nemo`)<br>Pang! 3 (Europe 950601) (`pang3`)<br>Pnickies (Japan 940608) (`pnickj`)<br>Pokonyan! Balloon (Japan 940322) (`pokonyan`)<br>Quiz & Dragons: Capcom Quiz Game (USA 920701) (`qad`)<br>Quiz Tonosama no Yabou 2: Zenkoku-ban (Japan 950123) (`qtono2j`)<br>Street Fighter II': Champion Edition (World 920513) (`sf2ce`)<br>Street Fighter II': Champion Re-Edit (Hack, v0.29.7) (`sf2cre`)<br>Street Fighter II': Hyper Fighting (World 921209) (`sf2hf`)<br>Street Fighter II': Special Champion Edition (Sr Street hack) (`sf2hfsce`)<br>Street Fighter II: The World Warrior (World 910522) (`sf2`)<br>Street Fighter Zero (CPS Changer, Japan 951020) (`sfzch`)<br>Strider (USA, B-Board 89624B-2) (`strider`)<br>The King of Dragons (World 910805) (`kod`)<br>Three Wonders (World 910520) (`3wonders`)<br>U.N. Squadron (USA) (`unsquad`)<br>Varth: Operation Thunderstorm (World 920714) (`varth`)<br>Willow (World) (`willow`) | Capcom, 1988–1996 — JOTEGO port | 2026-08-07 |
| [`cps15`](cores/cps15/README.md) | Cadillacs and Dinosaurs (World 930201) (`dino`)<br>Muscle Bomber Duo: Ultimate Team Battle (World 931206) (`mbombrd`)<br>Saturday Night Slam Masters (World 930713) (`slammast`)<br>Tenchi wo Kurau II: Sekiheki no Tatakai (CPS Changer, Japan 921031) (`wofch`)<br>The Punisher (World 930422) (`punisher`)<br>Warriors of Fate (World 921031) (`wof`) | Capcom, 1992–1994 | 2026-08-07 |
| [`dd`](cores/dd/README.md) | Double Dragon (World set 1) (`ddragon`) | Technos Japan (Taito license), 1987 | 2026-08-07 |
| [`dd2`](cores/dd2/README.md) | Double Dragon II: The Revenge (World) (`ddragon2`) | Technos Japan, 1988 | 2026-08-07 |
| [`ddrbl`](cores/ddrbl/) | Double Dribble (`ddribble`) | Konami, 1986 — JOTEGO port | 2026-08-07 |
| [`empirecity`](cores/empirecity/) | Empire City: 1931 (Seibu Kaihatsu, 1986) (jlrh) (`empcity`) | Seibu Kaihatsu, 1986 — jlrh port | 2026-08-07 |
| [`exed`](cores/exed/README.md) | Exed Exes (`exedexes`) | Capcom, 1985 — JOTEGO port | 2026-08-07 |
| [`flane`](cores/flane/README.md) | Fast Lane (`fastlane`) | Konami, 1987 | 2026-08-08 |
| [`flstory`](cores/flstory/README.md) | Bronx (bootleg of Cycle Shooting) (`bronx`)<br>Cycle Shooting (`cyclshtg`)<br>N.Y. Captor (rev 2) (`nycaptor`)<br>Onna Sanshirou - Typhoon Gal (rev 1) (`onna34ro`)<br>Rumba Lumber (rev 1) (`rumba`)<br>The FairyLand Story (`flstory`)<br>Victorious Nine (`victnine`) | Taito, 1984–1986 | 2026-08-08 |
| [`fround`](cores/fround/README.md) | The Final Round (version M) (`fround`) | Konami, 1988 | 2026-08-08 |
| [`gaiden`](cores/gaiden/README.md) | Raiga - Strato Fighter (US) (`stratof`)<br>Shadow Warriors (World, set 1) (`shadoww`)<br>Wild Fang - Tecmo Knight (World?) (`wildfang`) | Tecmo, 1988–1991 | 2026-08-08 |
| [`glass`](cores/glass/) | Glass (Gaelco, 1993) (jlrh) (`glassa`) | OMK / Gaelco, 1994 — jlrh port | 2026-08-07 |
| [`gng`](cores/gng/README.md) | Ghosts'n Goblins (World? set 1) (`gng`) | Capcom, 1985 — JOTEGO port | 2026-08-07 |
| [`gunsmk`](cores/gunsmk/README.md) | Gun.Smoke (World, 1985-11-15) (`gunsmoke`) | Capcom, 1985 — JOTEGO port | 2026-08-07 |
| [`karnov`](cores/karnov/) | Atomic Runner Chelnov (World) (`chelnov`)<br>Karnov (US, rev 6) (`karnov`)<br>Wonder Planet (Japan) (`wndrplnt`) | Data East Corporation, 1987–1988 — JOTEGO port | 2026-08-07 |
| [`kchamp`](cores/kchamp/README.md) | Karate Champ (US) (`kchamp`)<br>Karate Champ: Player Vs Player (US, set 1) (`kchampvs`) | Data East USA, 1984 — JOTEGO port | 2026-08-07 |
| [`kicker`](cores/kicker/README.md) | Kicker (`kicker`) | Konami, 1985 — JOTEGO port | 2026-08-07 |
| [`kiwi`](cores/kiwi/README.md) | Arkanoid - Revenge of DOH (World) (`arknoid2`)<br>Dr. Toppel's Adventure (World) (`drtoppel`)<br>Extermination (World) (`extrmatn`)<br>Insector X (World) (`insectx`)<br>Kabuki-Z (World) (`kabukiz`)<br>Kageki (World) (`kageki`)<br>The NewZealand Story (World, new version) (P0-043A PCB) (`tnzs`) | Taito Corporation Japan, 1987–1989 — JOTEGO port | 2026-08-07 |
| [`kunio`](cores/kunio/README.md) | Renegade (US) (`renegade`) | Technos Japan (Taito America license), 1986 — JOTEGO port | 2026-08-07 |
| [`labrun`](cores/labrun/README.md) | Trick Trap (World?) (`tricktrp`) | Konami, 1987 — JOTEGO port | 2026-08-07 |
| [`midres`](cores/midres/) | Midnight Resistance (World, set 1) (`midres`) | Data East Corporation, 1989 — JOTEGO port | 2026-08-07 |
| [`mikie`](cores/mikie/README.md) | Mikie (`mikie`) | Konami, 1984 — JOTEGO port | 2026-08-07 |
| [`moomesa`](cores/moomesa/) | Bucky O'Hare (ver EAB) (`bucky`)<br>Wild West C.O.W.-Boys of Moo Mesa (Konami, 1992) (jlrh) (`moomesa`) | Konami, 1992 — jlrh port | 2026-08-07 |
| [`mx5k`](cores/mx5k/README.md) | MX5000 (`mx5000`) | Konami, 1987 — JOTEGO port | 2026-08-07 |
| [`mystston`](cores/mystston/README.md) | Mysterious Stones: Dr. John's Adventure (bmo00) (`mystston`) | Technos Japan, 1984 | 2026-08-07 |
| [`ninja`](cores/ninja/README.md) | Bad Dudes vs. Dragonninja (US, revision 1) (`baddudes`)<br>Heavy Barrel (World) (`hbarrel`) | Data East Corporation, 1987–1988 — JOTEGO port | 2026-08-07 |
| [`opwolf`](cores/opwolf/) | Operation Wolf (World, rev 2, set 1) (jlrh) (`opwolf`) | Taito, 1987 — jlrh port | 2026-08-07 |
| [`outrun`](cores/outrun/README.md) | Out Run (sitdown-upright, Rev B) (`outrun`)<br>Turbo Out Run (Out Run upgrade) (FD1094 317-0118) (`toutrun`) | Sega, 1986–1989 — JOTEGO port | 2026-08-07 |
| [`paclan`](cores/paclan/) | Pac-Land (World) (`pacland`) | Namco, 1984 — JOTEGO port | 2026-08-07 |
| [`pang`](cores/pang/README.md) | Adventure Quiz 2 - Hatena? no Daibouken (Japan 900228) (`hatena`)<br>Block Block (World 911219 Joystick) (`block`)<br>Capcom World (Japan) (`cworld`)<br>Dokaben (Japan) (`dokaben`)<br>Dokaben 2 (Japan) (`dokaben2`)<br>Mahjong Gakuen (`mgakuen`)<br>Mahjong Gakuen 2 Gakuen-chou no Fukushuu (`mgakuen2`)<br>Pang (World) (`pang`)<br>Poker Ladies (`pkladies`)<br>Quiz Sangokushi (Japan) (`qsangoku`)<br>Quiz Tonosama no Yabou (Japan) (`qtono1`)<br>Super Marukin-Ban (Japan 911128) (`marukin`)<br>Super Pang (World 900914) (`spang`) | Capcom, 1988–1991 — JOTEGO port | 2026-08-07 |
| [`paroda`](cores/paroda/) | Parodius Da!: Shinwa kara Owarai e (World, set 1) (`parodius`)<br>Surprise Attack (World ver. K) (`suratk`) | Konami, 1990 — JOTEGO port | 2026-08-07 |
| [`pinpon`](cores/pinpon/README.md) | Konami's Ping-Pong (`pingpong`) | Konami, 1985 — JOTEGO port | 2026-08-07 |
| [`riders`](cores/riders/README.md) | Golfing Greats (World, version L) (`glfgreat`)<br>Lightning Fighters (World) (`lgtnfght`)<br>Sunset Riders (4 Players ver EAC) (`ssriders`)<br>Teenage Mutant Ninja Turtles: Turtles in Time (4 Players ver UAA) (`tmnt2`) | Konami, 1990–1991 — JOTEGO port | 2026-08-07 |
| [`roadf`](cores/roadf/README.md) | Hyper Sports (`hyperspt`)<br>Road Fighter (set 1) (`roadf`) | Konami, 1984 — JOTEGO port | 2026-08-07 |
| [`roc`](cores/roc/README.md) | Roc'n Rope (`rocnrope`) | Konami, 1983 — JOTEGO port | 2026-08-07 |
| [`rumble`](cores/rumble/README.md) | The Speed Rumbler (set 1) (`srumbler`) | Capcom, 1986 — JOTEGO port | 2026-08-07 |
| [`s16`](cores/s16/README.md) | Ace Attacker (Japan, S16A) [FD1094 317-0060] (`aceattaca`)<br>Action Fighter (World, S16A) [FD1089A 317-0018] (`afighter`)<br>Alex Kidd: The Lost Stars (Set 2, World, S16A) [No Protection] (`alexkidd`)<br>Body Slam (World, S16) [8751 317-0015] (`bodyslam`)<br>Fantasy Zone (Rev A, World, S16A) [No Protection] (`fantzone`)<br>Major League (World, S16A) [No Protection] (`mjleague`)<br>Quartet (Rev A, 4p, World, S16A) [8751 315-5194] (`quartet`)<br>Quartet 2 (World, S16A) [No Protection] (`quartet2a`)<br>SDI: Strategic Defense Initiative (Japan, New Ver., S16A) [FD1089B 317-0027] (`sdi`)<br>Shinobi (Set 6, World, S16A) [No Protection] (`shinobi`)<br>Tetris (Set 4, Japan, S16A) [FD1094 317-0093] (`tetris`) | Sega, 1985–1988 — JOTEGO port | 2026-08-07 |
| [`s16b`](cores/s16b/README.md) | Alien Syndrome (set 4, System 16B, unprotected) (`aliensyn`)<br>Altered Beast (set 8) (8751 317-0078) (`altbeast`)<br>Aurail (set 3, US) (unprotected) (`aurail`)<br>Bay Route (set 3, World) (FD1094 317-0116) (`bayroute`)<br>Bullet (FD1094 317-0041) (`bullet`)<br>Cotton (set 4, World) (FD1094 317-0181a) (`cotton`)<br>Cyber Police ESWAT (set 4, World) (FD1094 317-0130) (`eswat`)<br>Dunk Shot (Rev C, FD1089A 317-0022) (`dunkshot`)<br>Dynamite Dux (set 3, World) (FD1094 317-0096) (`ddux`)<br>Excite League (FD1094 317-0079) (`exctleag`)<br>Fantasy Zone II - The Tears of Opa-Opa (System 16C version) (`fantzn2x`)<br>Flash Point (set 2, Japan) (FD1094 317-0127A) (`fpoint`)<br>Golden Axe (set 6, US) (8751 317-123A) (`goldnaxe`)<br>MVP (set 2, US) (FD1094 317-0143) (`mvp`)<br>Passing Shot (World, 2 Players) (FD1094 317-0080) (`passsht`)<br>Riot City (Japan) (`riotcity`)<br>RyuKyu (Rev A, Japan) (FD1094 317-5023A) (`ryukyu`)<br>Sonic Boom (FD1094 317-0053) (`sonicbom`)<br>Sukeban Jansi Ryuko (set 2, System 16B, FD1089B 317-5021) (`sjryuko`)<br>Super League (FD1094 317-0045) (`suprleag`)<br>Time Scanner (set 2, System 16B) (`timescan`)<br>Toryumon (`toryumon`)<br>Tough Turf (set 1, US) (8751 317-0099) (`tturfu`)<br>Wonder Boy III - Monster Lair (set 6, World, System 16B) (8751 317-0098) (`wb3`)<br>Wrestle War (set 3, World) (8751 317-0103) (`wrestwar`) | Sega, 1987–2008 — JOTEGO port | 2026-08-07 |
| [`s18`](cores/s18/README.md) | Alien Storm (World, 2 Players) (FD1094 317-0154) (`astorm`)<br>Bloxeed (Japan) (FD1094 317-0139) (`bloxeed`)<br>Clockwork Aquario (prototype) (`aquario`)<br>Clutch Hitter (US) (FD1094 317-0176) (`cltchitr`)<br>D. D. Crew (World, 3 Players) (FD1094 317-0190) (`ddcrew`)<br>Desert Breaker (World) (FD1094 317-0196) (`desertbr`)<br>Hammer Away (Japan, prototype) (`hamaway`)<br>Laser Ghost (World) (FD1094 317-0166) (`lghost`)<br>Michael Jackson's Moonwalker (World) (FD1094-8751 317-0159) (`mwalk`)<br>Shadow Dancer (World) (`shdancer`)<br>Wally wo Sagase! (rev B, Japan, 2 players) (FD1094 317-0197B) (`wwallyj`) | Sega, 1989–2021 — JOTEGO port | 2026-08-07 |
| [`sarms`](cores/sarms/README.md) | Hyper Dyne Side Arms (World, 861129) (`sidearms`) | Capcom, 1986 — JOTEGO port | 2026-08-07 |
| [`sbaskt`](cores/sbaskt/README.md) | Super Basketball (version I, encrypted) (`sbasketb`) | Konami, 1984 — JOTEGO port | 2026-08-07 |
| [`sectnz`](cores/sectnz/README.md) | Legendary Wings (US, rev. C) (`lwings`)<br>Section Z (US) (`sectionz`) | Capcom, 1985–1986 — JOTEGO port | 2026-08-07 |
| [`sf`](cores/sf/README.md) | Street Fighter (US, set 1) (`sf`) | Capcom, 1987 — JOTEGO port | 2026-08-07 |
| [`shanon`](cores/shanon/README.md) | Super Hang-On (sitdown-upright) (unprotected) (`shangon`) | Sega, 1987 — JOTEGO port | 2026-08-07 |
| [`shouse`](cores/shouse/README.md) | Bakutotsu Kijuutei (`bakutotu`)<br>Blast Off (Japan) (`blastoff`)<br>Blazer (Japan) (`blazer`)<br>Boxy Boy (World, SB2) (`boxyboy`)<br>Chou Zetsurinjin Berabowman (Japan, Rev C) (`berabohm`)<br>Dangerous Seed (Japan) (`dangseed`)<br>Dragon Spirit (new version (DS3)) (`dspirit`)<br>Face Off (Japan 2 Players) (`faceoff`)<br>Galaga '88 (`galaga88`)<br>Marchen Maze (Japan) (`mmaze`)<br>Pac-Mania (`pacmania`)<br>Pistol Daimyo no Bouken (Japan) (`pistoldm`)<br>Pro Tennis World Court (Japan) (`wldcourt`)<br>Pro Yakyuu World Stadium (Japan) (`ws`)<br>Quester (Japan) (`quester`)<br>Rompers (Japan, new version (Rev B)) (`rompers`)<br>Shadowland (YD3) (`shadowld`)<br>Splatter House (World, new version (SH3)) (`splatter`)<br>Tank Force (US, 2 Players) (`tankfrce`) | Namco, 1987–1991 — JOTEGO port | 2026-08-07 |
| [`simson`](cores/simson/README.md) | Escape Kids (Asia, 4 Players) (`esckids`)<br>The Simpsons (4 Players World, set 1) (`simpsons`)<br>Vendetta (World, 4 Players, ver. T) (`vendetta`) | Konami, 1991 — JOTEGO port | 2026-08-07 |
| [`slyspy`](cores/slyspy/) | Boulder Dash - Boulder Dash Part 2 (World) (`bouldash`)<br>Secret Agent (World, revision 3) (`secretag`) | Data East Corporation, 1989–1990 — JOTEGO port | 2026-08-07 |
| [`squash`](cores/squash/) | Squash (Gaelco, 1992) (jlrh) (`squash`) | Gaelco, 1992 — jlrh port | 2026-08-07 |
| [`thoop`](cores/thoop/) | Thunder Hoop (Gaelco, 1992) (jlrh) (`thoop`) | Gaelco, 1992 — jlrh port | 2026-08-07 |
| [`thoop2`](cores/thoop2/) | TH Strikes Back (Gaelco, 1994) (jlrh) (`thoop2`) | Gaelco, 1994 — jlrh port | 2026-08-07 |
| [`thundr`](cores/thundr/) | Alien Sector (`aliensec`)<br>Genpei ToumaDen (`genpeitd`)<br>Hopping Mappy (`hopmappy`)<br>Metro-Cross (set 1) (`metrocrs`)<br>Rolling Thunder (rev 3) (`rthunder`)<br>Sky Kid Deluxe (set 1) (`skykiddx`)<br>The Return of Ishtar (`roishtar`)<br>Wonder Momo (`wndrmomo`) | Namco, 1985–1987 — JOTEGO port | 2026-08-07 |
| [`tmnt`](cores/tmnt/README.md) | M.I.A. - Missing in Action (version T) (`mia`)<br>Punk Shot (US 4 Players) (`punkshot`)<br>Teenage Mutant Ninja Turtles (World 4 Players, version X) (`tmnt`)<br>Thunder Cross II (World) (`thndrx2`) | Konami, 1989–1991 — JOTEGO port | 2026-08-07 |
| [`toki`](cores/toki/README.md) | Cabal (World, Joystick) (`cabal`)<br>Toki (World, set 1) (`toki`) | TAD Corporation, 1988–1989 — JOTEGO port | 2026-08-07 |
| [`tora`](cores/tora/README.md) | F-1 Dream (`f1dream`)<br>Tiger Road (US) (`tigeroad`) | Capcom, 1987–1988 — JOTEGO port | 2026-08-07 |
| [`track`](cores/track/README.md) | Track & Field (`trackfld`) | Konami, 1983 — JOTEGO port | 2026-08-07 |
| [`trojan`](cores/trojan/README.md) | Avengers (US, rev. D) (`avengers`)<br>Trojan (US set 1) (`trojan`) | Capcom, 1986–1987 — JOTEGO port | 2026-08-07 |
| [`twin16`](cores/twin16/README.md) | Devil World (`devilw`)<br>Vulcan Venture (new) (`vulcan`) | Konami, 1987–1988 — JOTEGO port | 2026-08-07 |
| [`vigil`](cores/vigil/README.md) | Vigilante (World, Rev E) (`vigilant`) | Irem, 1988 — JOTEGO port | 2026-08-07 |
| [`wc`](cores/wc/README.md) | Gridiron Fight (World) (`gridiron`)<br>Tehkan World Cup (set 1) (`tehkanwc`) | Tehkan, 1985 — JOTEGO port | 2026-08-07 |
| [`wrally`](cores/wrally/) | World Rally Championship (Gaelco, 1993, checksum DE0D) (jlrh) (`wrally`) | Gaelco, 1993 — jlrh port | 2026-08-07 |
| [`wrally2`](cores/wrally2/) | World Rally 2 (Gaelco, 1995) (jlrh) (`wrally2a`) | Gaelco, 1995 — jlrh port | 2026-08-07 |
| [`wwfss`](cores/wwfss/README.md) | WWF Superstars (Europe) (`wwfsstar`) | Technos Japan, 1989 — JOTEGO port | 2026-08-07 |
| [`yiear`](cores/yiear/README.md) | Yie Ar Kung-Fu (version I) (`yiear`) | Konami, 1985 — JOTEGO port | 2026-08-07 |
