...
`cores/bigkarnk` is vendored from `jlrh/gaelco-fpga` (see `cores.json`'s `external.repo`/
...
Pinned base: `jlrh/gaelco-fpga` commit `3fb2ece6afd0e734acdd8eabb0062182ce39456d`.
