...
`cores/thoop` is vendored from `jlrh/gaelco-fpga` (see `cores.json`'s `external.repo`/
...
Pinned base: `jlrh/gaelco-fpga` commit `0c15713ba76be87442dc94805d23954865d5cde0`.
