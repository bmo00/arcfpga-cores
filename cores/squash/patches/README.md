...
`cores/squash` is vendored from `jlrh/gaelco-fpga` (see `cores.json`'s `external.repo`/
...
Pinned base: `jlrh/gaelco-fpga` commit `d4d634512a2e0c67255b2db96ef86be5914212e0`.
